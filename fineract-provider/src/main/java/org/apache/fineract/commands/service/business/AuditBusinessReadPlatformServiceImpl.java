...
public class AuditBusinessReadPlatformServiceImpl implements AuditBusinessReadPlatformService {
    ...
    public Page<AuditBusinessData> retrieveWaitingApproval(SearchParametersBusiness searchParameters) {
        ...
        return this.paginationHelper.fetchPage(this.jdbcTemplate, sqlBuilder.toString(), paramList.toArray(),
                this.auditWaitingApprovalMapper);
    }
    ...
    private static final class AuditMapper implements RowMapper<AuditBusinessData> {
        ...
        public AuditBusinessData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final LocalDateTime madeOnDate = JdbcSupport.getLocalDateTime(rs, "madeOnDate");
            final String checker = rs.getString("checker");
            final LocalDateTime checkedOnDate = JdbcSupport.getLocalDateTime(rs, "checkedOnDate");
