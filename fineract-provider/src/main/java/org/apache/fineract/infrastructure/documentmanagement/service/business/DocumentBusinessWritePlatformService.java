...
public interface DocumentBusinessWritePlatformService {

    @PreAuthorize(value = "hasAnyAuthority('ALL_FUNCTIONS', 'CREATE_DOCUMENT')")
    CommandProcessingResult createBase64Document(final String entityType, final Long entityId, final String apiRequestBodyAsJson);
