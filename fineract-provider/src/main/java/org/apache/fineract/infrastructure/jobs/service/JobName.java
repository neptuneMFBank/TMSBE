...
public enum JobName {
    ...
    COMMISSION_VEND_EOD("Commission Vend EOD"), LOCK_INACTIVITY_STAFF_USER("Lock Inactivity Staff User"), QUEUE_SELF_CLIENT_ACTIVATE(
            "Queue Self Client Activate"), UPDATE_DUE_OVERDRAFT("Update Due Overdraft"), REMINDER_LOAN_APPROVAL_CHECKS(
                    "Reminder Loan Approval Checks"), REMINDER_OVERDRAFT_APPROVAL_CHECKS(
                            "Reminder Overdraft Approval Checks"), QUEUE_OVERDRAFT_APPROVAL_CHECKS(
