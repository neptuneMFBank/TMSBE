...
import org.apache.fineract.infrastructure.security.constants.AuthenticationBusinessConstants;
import org.apache.fineract.portfolio.self.registration.SelfServiceApiConstants;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;

@Component
public final class AuthenticationBusinessCommandFromApiJsonDeserializer {

    private final FromJsonHelper fromApiJsonHelper;

    @Autowired
    public AuthenticationBusinessCommandFromApiJsonDeserializer(final FromJsonHelper fromApiJsonHelper) {
