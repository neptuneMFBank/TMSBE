 ...
 * under the License.
 */
package org.apache.fineract.notification.handler.business;
...
@Service
@CommandType(entity = "NOTIFICATION", action = "UPDATE")
public class UpdateNotificationBusinessCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.notificationBusinessWritePlatformService.updateNotificationReadStatus(command.entityId(), command);
    }
}
