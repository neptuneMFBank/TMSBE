...
@Service
@CommandType(entity = TransferApprovalApiResourceConstants.RESOURCE_NAME, action = "CREATE")
public class CreateTransferApprovalCommandHandler implements NewCommandSourceHandler {

    private final TransferApprovalWritePlatformService writePlatformService;

    @Autowired
    public CreateTransferApprovalCommandHandler(final TransferApprovalWritePlatformService writePlatformService) {
