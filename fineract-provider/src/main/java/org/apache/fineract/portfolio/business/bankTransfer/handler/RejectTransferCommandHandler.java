...
@Service
@CommandType(entity = TransferApprovalApiResourceConstants.RESOURCE_NAME, action = "REJECT")
public class RejectTransferCommandHandler implements NewCommandSourceHandler {

    private final TransferApprovalWritePlatformService writePlatformService;

    @Autowired
    public RejectTransferCommandHandler(final TransferApprovalWritePlatformService writePlatformService) {
