 ...
 * under the License.
 */
package org.apache.fineract.portfolio.business.merchant.dataqueries.api;
...
@Path("/merchant/datatables/{clientId}/{datatable}/{apptableId}")
@Component
@Scope("singleton")

@Tag(name = "Self Data Tables", description = "")
public class MerchantDatatablesBusinessApiResource {
