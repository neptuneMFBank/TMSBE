...
@Service
public class MerchantInventoryMapperReadServiceImpl implements MerchantInventoryMapperReadService {

    private final JdbcTemplate jdbcTemplate;

    @Autowired
    public MerchantInventoryMapperReadServiceImpl(final JdbcTemplate jdbcTemplate) {
