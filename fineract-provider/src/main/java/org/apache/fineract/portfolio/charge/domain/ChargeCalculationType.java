...
public enum ChargeCalculationType {
    ...
    PERCENT_OF_INTEREST(4, "chargeCalculationType.percent.of.interest"), PERCENT_OF_DISBURSEMENT_AMOUNT(5,
            "chargeCalculationType.percent.of.disbursement.amount"), // PERCENT_OF_AMOUNT_AND_INTEREST_AND_FEE(3000,
                                                                     // "chargeCalculationType.percent.of.amount.and.interest.and.fee")
    ;
    ...
    public boolean isPercentageBased() {
        return isPercentageOfAmount() || isPercentageOfAmountAndInterest() || isPercentageOfInterest() || isPercentageOfDisbursementAmount() // ||
                                                                                                                                             // isPercentageOfAmountAndInterestAndFee()
        ;
    }
