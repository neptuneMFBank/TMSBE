...
public enum ChargeTimeType {
    ...
    SHARE_PURCHASE(14, "chargeTimeType.sharespurchase"), SHARE_REDEEM(15, "chargeTimeType.sharesredeem"), SAVINGS_NOACTIVITY_FEE(16,
    ...
    public boolean isTimeOfUpfront() {
        return ChargeTimeType.UPFRONT.getValue().equals(this.value);
    }
