...
public final class ChargeEnumerations {
    ...
    public static EnumOptionData chargeTimeType(final ChargeTimeType type) {
        ...
        switch (type) {
            ...
            break;
            case UPFRONT:
                optionData = new EnumOptionData(ChargeTimeType.UPFRONT.getValue().longValue(), ChargeTimeType.UPFRONT.getCode(),
                        "Upfront Fee");
            break;
            case UPFRONT_HOLD:
                optionData = new EnumOptionData(ChargeTimeType.UPFRONT_HOLD.getValue().longValue(), ChargeTimeType.UPFRONT_HOLD.getCode(),
                        "Upfront Hold Fee");
            break;
    ...
    public static EnumOptionData chargeCalculationType(final ChargeCalculationType type) {
        ...
        switch (type) {
            ...
            case PERCENT_OF_AMOUNT_AND_INTEREST_AND_FEE:
                optionData = new EnumOptionData(ChargeCalculationType.PERCENT_OF_AMOUNT_AND_INTEREST_AND_FEE.getValue().longValue(),
                        ChargeCalculationType.PERCENT_OF_AMOUNT_AND_INTEREST_AND_FEE.getCode(), "% Loan Amount + Interest + Fee");
            break;
            default:
