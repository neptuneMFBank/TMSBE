...
public class ChargeWritePlatformServiceJpaRepositoryImpl implements ChargeWritePlatformService {
    ...
    private void handleDataIntegrityIssues(final JsonCommand command, final Throwable realCause, final Exception dve) {
        ...
        if (realCause.getMessage().contains("payment_type")) {
            ...
            throw new PlatformDataIntegrityException("error.msg.charge.duplicate.paymentType",
                    "Charge with paymentTypeId `" + paymentTypeId + "` already exists", "paymentTypeId", paymentTypeId);
        }
