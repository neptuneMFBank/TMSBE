...
import org.apache.fineract.portfolio.charge.service.*;
...
import static org.apache.fineract.portfolio.charge.service.ChargeEnumerations.chargeAppliesTo;
 ...
 */
@Service
public class ChargeUpfrontReadPlatformServiceImpl implements ChargeUpfrontReadPlatformService {
    ...
    @Autowired
    public ChargeUpfrontReadPlatformServiceImpl(final CurrencyReadPlatformService currencyReadPlatformService,
    ...
    @Override
    public ChargeUpfrontData retrieveNewChargeDetails() {

        final Collection<CurrencyData> currencyOptions = this.currencyReadPlatformService.retrieveAllowedCurrencies();
        final List<EnumOptionData> allowedChargeCalculationTypeOptions = this.retrieveCalculationTypes();
        final List<EnumOptionData> allowedChargeAppliesToOptions = this.retrieveApplicableToTypes();
        ...
        return ChargeUpfrontData.template(currencyOptions, allowedChargeCalculationTypeOptions, allowedChargeAppliesToOptions
        //,
    ...
    @Override
    @Cacheable(value = "chargesU", key = "T(org.apache.fineract.infrastructure.core.service.ThreadLocalContextUtil).getTenant().getTenantIdentifier().concat('chU')")
    public Collection<ChargeUpfrontData> retrieveAllCharges() {
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveAllChargesForCurrency(String currencyCode) {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public ChargeUpfrontData retrieveCharge(final Long chargeId) {
        try {
            final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveLoanProductCharges(final Long loanProductId) {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveLoanProductCharges(final Long loanProductId, final ChargeTimeType chargeTime) {
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveLoanApplicableFees() {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveLoanAccountApplicableCharges(final Long loanId, ChargeTimeType[] excludeChargeTimes) {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveLoanProductApplicableCharges(final Long loanProductId, ChargeTimeType[] excludeChargeTimes) {
        final ChargeMapper rm = new ChargeMapper();
        StringBuilder excludeClause = new StringBuilder("");
        Map<String, Object> paramMap = new HashMap<>();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveLoanApplicablePenalties() {
        final ChargeMapper rm = new ChargeMapper();
    ...
    private List<EnumOptionData> retrieveCalculationTypes() {
    ...
    private List<EnumOptionData> retrieveApplicableToTypes() {
        return Arrays.asList(chargeAppliesTo(ChargeAppliesTo.LOAN));
    }

    private static final class ChargeMapper implements RowMapper<ChargeUpfrontData> {
        ...
        @Override
        public ChargeUpfrontData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return ChargeUpfrontData.instance(id, name, amount, currency, chargeTimeType, chargeAppliesToType, chargeCalculationType,
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveSavingsProductApplicableCharges(final boolean feeChargesOnly) {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveSavingsApplicablePenalties() {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveSavingsProductCharges(final Long savingsProductId) {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveShareProductCharges(final Long shareProductId) {
        final ChargeMapper rm = new ChargeMapper();
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveSavingsAccountApplicableCharges(Long savingsAccountId) {
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveAllChargesApplicableToClients() {
        final ChargeMapper rm = new ChargeMapper();
        String sql = "select " + rm.chargeSchema() + " where c.is_deleted=false and c.is_active=true and c.charge_applies_to_enum=? ";
        sql += addInClauseToSQL_toLimitChargesMappedToOffice_ifOfficeSpecificProductsEnabled();
        sql += " order by c.name ";
    ...
    @Override
    public Collection<ChargeUpfrontData> retrieveSharesApplicableCharges() {
        final ChargeMapper rm = new ChargeMapper();
        String sql = "select " + rm.chargeSchema() + " where c.is_deleted=false and c.is_active=true and c.charge_applies_to_enum=? ";
        sql += addInClauseToSQL_toLimitChargesMappedToOffice_ifOfficeSpecificProductsEnabled();
        sql += " order by c.name ";
