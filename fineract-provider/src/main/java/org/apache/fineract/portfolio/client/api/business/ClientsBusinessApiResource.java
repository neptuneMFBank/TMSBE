...
public class ClientsBusinessApiResource {
    ...
    @ApiResponses({ @ApiResponse(responseCode = "200", description = "OK") })
    public String retrieveClientTransactions(@Context final UriInfo uriInfo, @PathParam("clientId") final Long clientId,
        ...
        final SearchParametersBusiness searchParameters = SearchParametersBusiness.forTransactions(transactionTypeId, null, offset, limit,
                orderBy, sortOrder, fromDate, toDate, depositAccountTypeId);
