...
public class ClientsBusinessApiResource {
    ...
    public String retrieveAll(@Context final UriInfo uriInfo, @QueryParam("bvn") @Parameter(description = "bvn") final String bvn, @QueryParam("nin") @Parameter(description = "nin") final String nin,
