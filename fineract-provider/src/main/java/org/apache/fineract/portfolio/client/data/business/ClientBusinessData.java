...
public final class ClientBusinessData implements Comparable<ClientBusinessData>, Serializable {
    ...
    public static ClientBusinessData pendingActivation(final String accountNo, final Long officeId, final String officeName, final Long id,
            final String displayName, final Long staffId, final String staffName, final ClientTimelineData timeline,
            final EnumOptionData legalForm, final StaffData supervisorStaffData, final String bvn, final Boolean iAgree) {
        ...
        return new ClientBusinessData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
                ...
                clientCollateralManagements, null, null, null, null, null, null, null, supervisorStaffData, bvn, iAgree);
    ...
    public static ClientBusinessData instance(final String accountNo, final EnumOptionData status, final CodeValueData subStatus,
        ...
        return new ClientBusinessData(accountNo, status, subStatus, officeId, officeName, transferToOfficeId, transferToOfficeName, id,
                ...
                clientTypeOptions, clientClassificationOptions, clientNonPersonConstitutionOptions, clientNonPersonMainBusinessLineOptions,
                clientNonPerson, clientLegalFormOptions, familyMemberOptions, legalForm, null, null, null, isStaff,
                clientCollateralManagements, null, null, null, null, null, null, null, null, null, null);
    ...
    public static ClientBusinessData templateWithSavingAccountOptions(final ClientBusinessData clientData,
        ...
        final Set<ClientCollateralManagementData> clientCollateralManagements = null;
        return new ClientBusinessData(clientData.accountNo, clientData.status, clientData.subStatus, clientData.officeId,
                ...
                clientData.isStaff, clientCollateralManagements, null, null, null, null, null, null, null, null, null, null);
