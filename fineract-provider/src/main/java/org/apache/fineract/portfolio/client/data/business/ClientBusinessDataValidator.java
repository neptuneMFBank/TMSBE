...
@Component
public final class ClientBusinessDataValidator {

    private final FromJsonHelper fromApiJsonHelper;
    private final ConfigurationReadPlatformService configurationReadPlatformService;

    @Autowired
    public ClientBusinessDataValidator(final FromJsonHelper fromApiJsonHelper,
    ...
    public void validateForCreate(final String json) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.clientNonPersonDetailsParamName, element)) {
            ...
            if (clientNonPersonJson != null) {
                this.fromApiJsonHelper.checkForUnsupportedParameters(typeOfMap, clientNonPersonJson,
                        ClientBusinessApiCollectionConstants.CLIENT_NON_PERSON_CREATE_REQUEST_DATA_PARAMETERS);
            }
        }
        ...
        baseDataValidator.reset().parameter(ClientApiConstants.legalFormIdParamName).value(legalFormId).notNull().inMinMaxRange(1, 37);
        ...
        if (this.configurationReadPlatformService.retrieveGlobalConfiguration("Enable-Address").isEnabled()
                && this.fromApiJsonHelper.parameterExists(ClientApiConstants.address, element)) {
    ...
    public void validateForUpdate(final String json) {
        ...
        if (this.fromApiJsonHelper.parameterExists(ClientApiConstants.clientNonPersonDetailsParamName, element)) {
            ...
            if (clientNonPersonJson != null) {
                this.fromApiJsonHelper.checkForUnsupportedParameters(typeOfMap, clientNonPersonJson,
                        ClientBusinessApiCollectionConstants.CLIENT_NON_PERSON_UPDATE_REQUEST_DATA_PARAMETERS);
            }
        }
    ...
    public void validateRejection(final JsonCommand command) {
        ...
        this.fromApiJsonHelper.checkForUnsupportedParameters(typeOfMap, json, ClientBusinessApiCollectionConstants.CLIENT_REJECT_DATA_PARAMETERS);
    ...
    public void validateWithdrawn(final JsonCommand command) {
        ...
        this.fromApiJsonHelper.checkForUnsupportedParameters(typeOfMap, json, ClientBusinessApiCollectionConstants.CLIENT_WITHDRAW_DATA_PARAMETERS);
