...
@Service
@CommandType(entity = "ADDRESS", action = "UPDATE_BUSINESS")
public class UpdateClientAddressBusinessCommandHandler implements NewCommandSourceHandler {

    private final AddressBusinessWritePlatformService writePlatformService;

    @Autowired
    public UpdateClientAddressBusinessCommandHandler(final AddressBusinessWritePlatformService writePlatformService) {
