...
public class ClientIdentifierBusinessReadPlatformServiceImpl implements ClientIdentifierBusinessReadPlatformService {
    ...
    private static final class ClientIdentityMapper implements RowMapper<ClientIdentifierBusinessData> {
        ...
        @Override
        public ClientIdentifierBusinessData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {

            final Long id = JdbcSupport.getLong(rs, "id");
            final Long attachmentId = JdbcSupport.getLong(rs, "attachmentId");
            ...
            return ClientIdentifierBusinessData.singleItem(id, clientId, documentType, documentKey, status, description, attachmentId);
        }
