...
public interface LoanBusinessApiConstants {
   ...
   "loanProductDescription":"Test Loan",
   ...
   "loanOfficerOptions":[
      ...
      },
      {
         ...
         "firstname":"Daniel",
         "lastname":"Michael",
         "displayName":"Michael, Daniel",
         "mobileNo":"07062902851",
         "officeId":1,
         "officeName":"Head Office",
         "isLoanOfficer":true,
         "isActive":true,
      ...
      },
      {
         ...
         "firstname":"Chibuikem",
         "lastname":"Simplify",
         "displayName":"Simplify, Chibuikem",
         "mobileNo":"09020867386",
         "officeId":1,
         "officeName":"Head Office",
         "isLoanOfficer":true,
         "isActive":true,
   ...
   "interestRateFrequencyTypeOptions":[
      ...
      {
         "id":4,
         "code":"interestRateFrequency.periodFrequencyType.whole_term",
         "value":"Whole term"
      }
   ],
   ...
   "accountLinkingOptions":[
      {
         ...
         "clientName":"Test Test",
         "productId":1,
         "productName":"Eso-E Savings",
         "fieldOfficerId":3,
         "fieldOfficerName":"Akubo, Sylvernus",
         "currency":{
            "code":"NGN",
            "name":"Nigerian Naira",
            "decimalPlaces":2,
   ...
   "product":{
      ...
      "isInterestRecalculationEnabled":false,
      "minimumDaysBetweenDisbursalAndFirstRepayment":25,
      "canDefineInstallmentAmount":false,
   ...
   "delinquent":{
    ...
    public static String loanTemplateConfig(final LoansApiResource loansApiResource, final String apiRequestBodyAsJson,
            final FromJsonHelper fromApiJsonHelper, final Long clientDefaultId, final boolean staffInSelectedOfficeOnly, @Context final UriInfo uriInfo) {
        ...
        final Long productId
                = fromApiJsonHelper.extractLongNamed(LoanApiConstants.productIdParameterName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.clientIdParameterName, apiRequestBodyAsJsonElement)) {
            clientId
                    = fromApiJsonHelper.extractLongNamed(LoanApiConstants.clientIdParameterName, apiRequestBodyAsJsonElement);
            loanType = "individual";
            ...
            groupId
                    = fromApiJsonHelper.extractLongNamed(LoanApiConstants.groupIdParameterName, apiRequestBodyAsJsonElement);
            loanType = "group";
        ...
        final String loanTemplate = loansApiResource.template(clientId, groupId, productId, loanType, staffInSelectedOfficeOnly, true, uriInfo);
        //loanTemplate config
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.clientActiveLoanOptions, loanTemplateElement)) {
            clientActiveLoanOptions = fromApiJsonHelper.extractJsonObjectNamed(LoanApiConstants.clientActiveLoanOptions, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(expectedDisbursementDateParameterName, apiRequestBodyAsJsonElement)) {
            expectedDisbursementDate = fromApiJsonHelper.extractStringNamed(expectedDisbursementDateParameterName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.submittedOnDateParameterName, apiRequestBodyAsJsonElement)) {
            submittedOnDate = fromApiJsonHelper.extractStringNamed(LoanApiConstants.submittedOnDateParameterName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.loanTypeParameterName, apiRequestBodyAsJsonElement)) {
            ...
            if (clientActiveLoanOptions != null
                    && fromApiJsonHelper.parameterExists(LoanApiConstants.loanTypeParameterName, clientActiveLoanOptions)) {
                loanType = fromApiJsonHelper.extractStringNamed(LoanApiConstants.loanTypeParameterName, clientActiveLoanOptions);
            }
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.repaymentsStartingFromDateParameterName, apiRequestBodyAsJsonElement)) {
            repaymentsStartingFromDate = fromApiJsonHelper.extractStringNamed(LoanApiConstants.repaymentsStartingFromDateParameterName, apiRequestBodyAsJsonElement);
        } else {
            if (fromApiJsonHelper.parameterExists(minimumDaysBetweenDisbursalAndFirstRepaymentParameterName, loanTemplateElement)) {
                Integer minimumDaysBetweenDisbursalAndFirstRepayment = fromApiJsonHelper.extractIntegerSansLocaleNamed(minimumDaysBetweenDisbursalAndFirstRepaymentParameterName, loanTemplateElement);
        ...
        final Integer fundId
                = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.fundIdParameterName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.principalParamName, apiRequestBodyAsJsonElement)) {
            principal = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(LoanApiConstants.principalParamName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.loanTermFrequencyParameterName, apiRequestBodyAsJsonElement)) {
            loanTermFrequency = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.loanTermFrequencyParameterName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.loanTermFrequencyTypeParameterName, apiRequestBodyAsJsonElement)) {
            loanTermFrequencyType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.loanTermFrequencyTypeParameterName, apiRequestBodyAsJsonElement);
        } else {
            final JsonElement termPeriodFrequencyType = fromApiJsonHelper.extractJsonObjectNamed(termPeriodFrequencyTypeParameterName,
                    loanTemplateElement);
            loanTermFrequencyType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.idParameterName, termPeriodFrequencyType);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.numberOfRepaymentsParameterName, apiRequestBodyAsJsonElement)) {
            numberOfRepayments = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.numberOfRepaymentsParameterName, apiRequestBodyAsJsonElement);
        } else {
            numberOfRepayments = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.numberOfRepaymentsParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.repaymentEveryParameterName, apiRequestBodyAsJsonElement)) {
            repaymentEvery = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.repaymentEveryParameterName, apiRequestBodyAsJsonElement);
        } else {
            repaymentEvery = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.repaymentEveryParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.repaymentFrequencyTypeParameterName, apiRequestBodyAsJsonElement)) {
            repaymentFrequencyType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.repaymentFrequencyTypeParameterName, apiRequestBodyAsJsonElement);
        } else {
            final JsonElement repaymentFrequencyElement = fromApiJsonHelper.extractJsonObjectNamed(LoanApiConstants.repaymentFrequencyTypeParameterName, loanTemplateElement);
            repaymentFrequencyType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.idParameterName, repaymentFrequencyElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.interestRatePerPeriodParameterName, apiRequestBodyAsJsonElement)) {
            interestRatePerPeriod = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(LoanApiConstants.interestRatePerPeriodParameterName, apiRequestBodyAsJsonElement);
        } else {
            interestRatePerPeriod = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(LoanApiConstants.interestRatePerPeriodParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.amortizationTypeParameterName, apiRequestBodyAsJsonElement)) {
            amortizationType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.amortizationTypeParameterName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.isEqualAmortizationParam, apiRequestBodyAsJsonElement)) {
            isEqualAmortization = fromApiJsonHelper.extractBooleanNamed(LoanApiConstants.isEqualAmortizationParam, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.interestTypeParameterName, apiRequestBodyAsJsonElement)) {
            interestType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.interestTypeParameterName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.interestChargedFromDateParameterName, apiRequestBodyAsJsonElement)) {
            interestChargedFromDate = fromApiJsonHelper.extractStringNamed(LoanApiConstants.interestChargedFromDateParameterName, apiRequestBodyAsJsonElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.interestCalculationPeriodTypeParameterName, apiRequestBodyAsJsonElement)) {
            interestCalculationPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.interestCalculationPeriodTypeParameterName, apiRequestBodyAsJsonElement);
        } else {
            final JsonElement interestCalculationPeriod = fromApiJsonHelper.extractJsonObjectNamed(LoanApiConstants.interestCalculationPeriodTypeParameterName,
                    loanTemplateElement);
            interestCalculationPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.idParameterName, interestCalculationPeriod);
        }
        ...
        if (fromApiJsonHelper.parameterExists(allowPartialPeriodInterestCalcualtionParameterName, apiRequestBodyAsJsonElement)) {
            allowPartialPeriodInterestCalcualtion = fromApiJsonHelper.extractBooleanNamed(allowPartialPeriodInterestCalcualtionParameterName, apiRequestBodyAsJsonElement);
        } else {
            allowPartialPeriodInterestCalcualtion = fromApiJsonHelper.extractBooleanNamed(allowPartialPeriodInterestCalcualtionParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.inArrearsToleranceParameterName, apiRequestBodyAsJsonElement)) {
            inArrearsTolerance = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(LoanApiConstants.inArrearsToleranceParameterName, apiRequestBodyAsJsonElement);
        } else {
            inArrearsTolerance = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(LoanApiConstants.inArrearsToleranceParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.transactionProcessingStrategyIdParameterName, apiRequestBodyAsJsonElement)) {
            transactionProcessingStrategyId = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.transactionProcessingStrategyIdParameterName, apiRequestBodyAsJsonElement);
        } else {
            transactionProcessingStrategyId = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.transactionProcessingStrategyIdParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(graceOnArrearsAgeingParameterName, apiRequestBodyAsJsonElement)) {
            graceOnArrearsAgeing = fromApiJsonHelper.extractIntegerSansLocaleNamed(graceOnArrearsAgeingParameterName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.graceOnInterestChargedParameterName, apiRequestBodyAsJsonElement)) {
            graceOnInterestCharged = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.graceOnInterestChargedParameterName, apiRequestBodyAsJsonElement);
        } else {
            graceOnInterestCharged = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.graceOnInterestChargedParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.graceOnPrincipalPaymentParameterName, apiRequestBodyAsJsonElement)) {
            graceOnPrincipalPayment = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.graceOnPrincipalPaymentParameterName, apiRequestBodyAsJsonElement);
        } else {
            graceOnPrincipalPayment = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.graceOnPrincipalPaymentParameterName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.graceOnInterestPaymentParameterName, apiRequestBodyAsJsonElement)) {
            graceOnInterestPayment = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.graceOnInterestPaymentParameterName, apiRequestBodyAsJsonElement);
        } else {
            graceOnInterestPayment = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.graceOnInterestPaymentParameterName, loanTemplateElement);
        }
        ...
        final Boolean isRatesEnabled
                = fromApiJsonHelper.extractBooleanNamed(isRatesEnabledParameterName, loanTemplateElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.loanOfficerIdParameterName, apiRequestBodyAsJsonElement)) {
            final Long loanOfficerId = fromApiJsonHelper.extractLongNamed(LoanApiConstants.loanOfficerIdParameterName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.loanPurposeIdParameterName, apiRequestBodyAsJsonElement)) {
            final Long loanPurposeId = fromApiJsonHelper.extractLongNamed(LoanApiConstants.loanPurposeIdParameterName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.externalIdParameterName, apiRequestBodyAsJsonElement)) {
            final String externalId = fromApiJsonHelper.extractStringNamed(LoanApiConstants.externalIdParameterName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.createStandingInstructionAtDisbursementParameterName, apiRequestBodyAsJsonElement)) {
            createStandingInstructionAtDisbursement = fromApiJsonHelper.extractBooleanNamed(LoanApiConstants.createStandingInstructionAtDisbursementParameterName, apiRequestBodyAsJsonElement);
            if (BooleanUtils.isTrue(createStandingInstructionAtDisbursement)) {
                jsonObjectLoan.addProperty(LoanApiConstants.createStandingInstructionAtDisbursementParameterName, createStandingInstructionAtDisbursement);
                final Long linkAccountId = fromApiJsonHelper.extractLongNamed(LoanApiConstants.linkAccountIdParameterName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.repaymentFrequencyDayOfWeekTypeParameterName, apiRequestBodyAsJsonElement)) {
            final Integer repaymentFrequencyDayOfWeekType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.repaymentFrequencyDayOfWeekTypeParameterName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(LoanApiConstants.repaymentFrequencyNthDayTypeParameterName, apiRequestBodyAsJsonElement)) {
            final Integer repaymentFrequencyNthDayType = fromApiJsonHelper.extractIntegerSansLocaleNamed(LoanApiConstants.repaymentFrequencyNthDayTypeParameterName, apiRequestBodyAsJsonElement);
