...
public final class LoanBusinessAccountData {
    ...
    private DocumentProductConfigData documentConfigData;
    ...
    public static LoanBusinessAccountData importInstanceIndividual(EnumOptionData loanTypeEnumOption, Long clientId, Long productId,
        ...
        return new LoanBusinessAccountData(loanTypeEnumOption, clientId, productId, loanOfficerId, submittedOnDate, fundId, principal,
    ...
    public static LoanBusinessAccountData importInstanceGroup(EnumOptionData loanTypeEnumOption, Long groupIdforGroupLoan, Long productId,
            Long loanOfficerId, LocalDate submittedOnDate, Long fundId, BigDecimal principal, Integer numberOfRepayments,
        ...
        return new LoanBusinessAccountData(loanTypeEnumOption, groupIdforGroupLoan, productId, loanOfficerId, submittedOnDate, fundId,
                principal, numberOfRepayments, repaidEvery, repaidEveryFrequencyEnums, loanTermFrequency, loanTermFrequencyTypeEnum,
    ...
    private LoanBusinessAccountData(EnumOptionData loanType, Long clientId, Long productId, Long loanOfficerId, LocalDate submittedOnDate,
    ...
    public static final Comparator<LoanBusinessAccountData> ClientNameComparator = new Comparator<LoanBusinessAccountData>() {

        @Override
        public int compare(LoanBusinessAccountData loan1, LoanBusinessAccountData loan2) {
    ...
    public static LoanBusinessAccountData collateralTemplate(final Collection<CodeValueData> loanCollateralOptions) {
        ...
        return new LoanBusinessAccountData(id, accountNo, status, externalId, clientId, clientAccountNo, clientName, clientOfficeId, group,
    ...
    public static LoanBusinessAccountData populateClientDefaults(final LoanBusinessAccountData acc,
            final LoanBusinessAccountData clientAcc) {

        return new LoanBusinessAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, clientAcc.clientId, clientAcc.clientAccountNo,
    ...
    public static LoanBusinessAccountData populateGroupDefaults(final LoanBusinessAccountData acc, final LoanBusinessAccountData groupAcc) {

        return new LoanBusinessAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo,
                acc.clientName, acc.clientOfficeId, groupAcc.group, acc.loanType, acc.loanProductId, acc.loanProductName,
                acc.loanProductDescription, acc.isLoanProductLinkedToFloatingRate, acc.fundId, acc.fundName, acc.loanPurposeId,
                acc.loanPurposeName, acc.loanOfficerId, acc.loanOfficerName, acc.currency, acc.proposedPrincipal, acc.principal,
                acc.approvedPrincipal, acc.netDisbursalAmount, acc.totalOverpaid, acc.inArrearsTolerance, acc.termFrequency,
                acc.termPeriodFrequencyType, acc.numberOfRepayments, acc.repaymentEvery, acc.repaymentFrequencyType,
    ...
    public static LoanBusinessAccountData loanProductWithTemplateDefaults(final LoanProductData product,
    ...
    public static LoanBusinessAccountData populateLoanProductDefaults(final LoanBusinessAccountData acc, final LoanProductData product) {
        ...
        return new LoanBusinessAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo,
                acc.clientName, acc.clientOfficeId, acc.group, acc.loanType, product.getId(), product.getName(), product.getDescription(),
     ...
     */
    public static LoanBusinessAccountData basicLoanDetails(final Long id, final String accountNo, final LoanStatusEnumData status,
     ...
     */
    public static LoanBusinessAccountData associationsAndTemplate(final LoanBusinessAccountData acc,
            ...
            final Collection<GuarantorData> guarantors, final CalendarData calendarData, final Collection<LoanProductData> productOptions,
            final Collection<EnumOptionData> termFrequencyTypeOptions, final Collection<EnumOptionData> repaymentFrequencyTypeOptions,
            final Collection<EnumOptionData> repaymentFrequencyNthDayTypeOptions,
            final Collection<EnumOptionData> repaymentFrequencyDayOfWeekTypeOptions,
    ...
    public static LoanBusinessAccountData associationsAndTemplate(final LoanBusinessAccountData acc,
            final Collection<LoanProductData> productOptions, final Collection<StaffData> allowedLoanOfficers,
            final Collection<CalendarData> calendarOptions, final Collection<PortfolioAccountData> accountLinkingOptions,
    ...
    public static LoanBusinessAccountData associateGroup(final LoanBusinessAccountData acc, final GroupGeneralData group) {

        return new LoanBusinessAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo,
                acc.clientName, acc.clientOfficeId, group, acc.loanType, acc.loanProductId, acc.loanProductName, acc.loanProductDescription,
    ...
    public static LoanBusinessAccountData associateMemberVariations(final LoanBusinessAccountData acc,
            final Map<Long, Integer> memberLoanCycle) {
    ...
    public static LoanBusinessAccountData withInterestRecalculationCalendarData(final LoanBusinessAccountData acc,
    ...
    public static LoanBusinessAccountData withLoanCalendarData(final LoanBusinessAccountData acc, final CalendarData calendarData) {
        return new LoanBusinessAccountData(acc.id, acc.accountNo, acc.status, acc.externalId, acc.clientId, acc.clientAccountNo,
                acc.clientName, acc.clientOfficeId, acc.group, acc.loanType, acc.loanProductId, acc.loanProductName,
                acc.loanProductDescription, acc.isLoanProductLinkedToFloatingRate, acc.fundId, acc.fundName, acc.loanPurposeId,
                acc.loanPurposeName, acc.loanOfficerId, acc.loanOfficerName, acc.currency, acc.proposedPrincipal, acc.principal,
    ...
    public static LoanBusinessAccountData withOriginalSchedule(final LoanBusinessAccountData acc, final LoanScheduleData originalSchedule) {
    ...
    private LoanBusinessAccountData(final Long id, //
     ...
     */
    public static LoanBusinessAccountData emptyTemplate() {
        final Collection<CodeValueData> loanCollateralOptions = null;

        return LoanBusinessAccountData.collateralTemplate(loanCollateralOptions);
    }
    ...
    public Long getActivationChannelId() {
        return activationChannelId;
    }

    public void setActivationChannelId(Long activationChannelId) {
        this.activationChannelId = activationChannelId;
    }

    public String getActivationChannelName() {
        return activationChannelName;
    }
    ...
    public DocumentProductConfigData getDocumentConfigData() {
        return documentConfigData;
    }

    public void setDocumentConfigData(DocumentProductConfigData documentConfigData) {
