...
public final class LoanBusinessApplicationCommandFromApiJsonHelper {
    ...
    final Set<String> supportedParametersSubmitLoanApproval = new HashSet<>(Arrays.asList(ClientBusinessApiConstants.paymentTypeIdParamName, DocumentConfigApiConstants.locationParam));
    /**
    ...
    final Set<String> supportedParameters = new HashSet<>(Arrays.asList(LoanApiConstants.dateFormatParameterName,
            ...
            LoanBusinessApiConstants.activationChannelIdParam));
    ...
    public void validateForCreate(final String json, final boolean isMeetingMandatoryForJLGLoans, final LoanProduct loanProduct) {
        ...
        final Long activationChannelId = this.fromApiJsonHelper.extractLongNamed(LoanBusinessApiConstants.activationChannelIdParam,
                element);
        baseDataValidator.reset().parameter(LoanBusinessApiConstants.activationChannelIdParam).value(activationChannelId).notNull()
    ...
    public void validateForModify(final String json, final LoanProduct loanProduct, final Loan existingLoanApplication) {
        ...
        if (this.fromApiJsonHelper.parameterExists(LoanBusinessApiConstants.activationChannelIdParam, element)) {
            atLeastOneParameterPassedForUpdate = true;
            final Long activationChannelId = this.fromApiJsonHelper.extractLongNamed(LoanBusinessApiConstants.activationChannelIdParam,
                    element);
            baseDataValidator.reset().parameter(LoanBusinessApiConstants.activationChannelIdParam).value(activationChannelId).notNull()
