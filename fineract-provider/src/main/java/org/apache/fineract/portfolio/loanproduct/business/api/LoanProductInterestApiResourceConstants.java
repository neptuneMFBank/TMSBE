...
public final class LoanProductInterestApiResourceConstants {

    private LoanProductInterestApiResourceConstants() {

    }

    public static final String RESOURCENAME = "LOANPRODUCT_INTEREST";
    ...
    public static final Set<String> RESPONSE_TEMPLATE_PARAMETERS = new HashSet<>(Arrays.asList(LOANPRODUCTOPTIONS));
