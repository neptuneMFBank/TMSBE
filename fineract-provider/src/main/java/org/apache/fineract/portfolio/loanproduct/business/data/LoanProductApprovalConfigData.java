...
@Data
public class LoanProductApprovalConfigData implements Serializable {
    ...
    public static LoanProductApprovalConfigData instance(Long id, RoleData roleData, BigDecimal minApprovalAmount,
