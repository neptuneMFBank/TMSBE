...
@Service
public class LoanProductApprovalConfigRepositoryWrapper {

    private final LoanProductApprovalConfigRepository repository;

    @Autowired
    public LoanProductApprovalConfigRepositoryWrapper(final LoanProductApprovalConfigRepository repository) {
