...
public class LoanProductlnterestConfigRepositoryWrapper {
    ...
    public LoanProductInterestConfig findOneWithNotFoundDetection(final Long id) {
        return this.repository.findById(id)
                .orElseThrow(() -> new LoanProductApprovalNotFoundException("Loan product interest config does not exit for id " + id));
    }
