...
@Service
@CommandType(entity = LoanProductApprovalApiResourceConstants.RESOURCENAME, action = "CREATE")
public class CreateLoanProductApprovalCommandHandler implements NewCommandSourceHandler {

    private final LoanProductApprovalWriteService loanProductApprovalWriteService;

    @Autowired
    public CreateLoanProductApprovalCommandHandler(final LoanProductApprovalWriteService loanProductApprovalWriteService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.loanProductApprovalWriteService.createLoanProductApproval(command);
    }
}
