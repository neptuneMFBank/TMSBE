...
@Service
@CommandType(entity = LoanProductInterestApiResourceConstants.RESOURCENAME, action = "CREATE")
public class CreateLoanProductInterestCommandHandler implements NewCommandSourceHandler {

    private final LoanProductInterestWriteService loanProductInterestWriteService;

    @Autowired
    public CreateLoanProductInterestCommandHandler(final LoanProductInterestWriteService loanProductInterestWriteService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.loanProductInterestWriteService.createLoanProductInterest(command);
    }
}
