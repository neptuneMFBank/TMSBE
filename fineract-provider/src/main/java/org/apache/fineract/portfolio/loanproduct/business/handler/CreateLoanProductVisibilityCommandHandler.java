...
@Service
@CommandType(entity = ProductVisibilityApiResourceConstants.LOAN_VISIBILITY_RESOURCENAME, action = "CREATE")
public class CreateLoanProductVisibilityCommandHandler implements NewCommandSourceHandler {

    private final LoanProductVisibilityWriteService loanProductVisibilityWriteService;

    @Autowired
    public CreateLoanProductVisibilityCommandHandler(final LoanProductVisibilityWriteService loanProductVisibilityWriteService) {
