...
@Service
@CommandType(entity = "LOANPRODUCT", action = "UPDATE_PAYMENT")
public class UpdateLoanProductPaymentTypeConfigCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.loanProductPaymentTypeConfigWriteService.updateLoanProductPaymentTypeConfig(command.entityId(), command);
    }
}
