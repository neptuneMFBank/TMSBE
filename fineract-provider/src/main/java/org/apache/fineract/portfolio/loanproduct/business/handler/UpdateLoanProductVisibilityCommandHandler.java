...
@Service
@CommandType(entity = LoanProductVisibilityApiResourceConstants.RESOURCENAME, action = "UPDATE")
public class UpdateLoanProductVisibilityCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public UpdateLoanProductVisibilityCommandHandler(final LoanProductVisibilityWriteService loanProductVisibilityWriteService) {
