...
public interface LoanProductApprovalReadPlatformService {

    Page<LoanProductApprovalData> retrieveAll(final SearchParametersBusiness searchParameters);

    LoanProductApprovalData retrieveOne(final Long id);

    Collection<LoanProductApprovalConfigData> retrieveConfig(final Long loanProductApprovalId);

    LoanProductApprovalData retrieveOneViaLoanProduct(final Long loanProductId);
