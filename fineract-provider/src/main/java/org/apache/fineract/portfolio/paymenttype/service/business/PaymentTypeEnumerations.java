...
public final class PaymentTypeEnumerations {

    private PaymentTypeEnumerations() {

    }

    public static EnumOptionData paymentCalculationType(final int id) {
        return paymentCalculationType(PaymentCalculationType.fromInt(id));
    }
