...
public class DocumentProductConfigWriteServiceImpl implements DocumentProductConfigWriteService {
    ...
    @Autowired
    public DocumentProductConfigWriteServiceImpl(final PlatformSecurityContext context, final DocumentConfigDataValidator fromApiJsonDeserializer,
    ...
    public CommandProcessingResult createProductDocumentConfig(JsonCommand command) {
        ...
        try {
            ...
            final Integer formId = this.fromApiJsonHelper.extractIntegerSansLocaleNamed(DocumentConfigApiConstants.formIdParam,
                    jsonElement);
            final ClientDocumentConfig clientDocumentConfig = ClientDocumentConfig.instance(name, formId, description, true, typeParam);
            if (!codes.isEmpty()) {
...
//            }
    ...
    @Override
    public CommandProcessingResult updateProductDocumentConfig(Long entityId, JsonCommand command) {
        this.context.authenticatedUser();
