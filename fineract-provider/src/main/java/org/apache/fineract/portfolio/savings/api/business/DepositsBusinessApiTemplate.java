...
public interface DepositsBusinessApiTemplate {
    ...
    public static String recurringTemplateConfig(final RecurringDepositAccountsApiResource recurringDepositAccountsApiResource, final String apiRequestBodyAsJson,
            final FromJsonHelper fromApiJsonHelper, final boolean staffInSelectedOfficeOnly,
        ...
        String fieldOfficerId = fromApiJsonHelper.extractStringNamed(SavingsApiConstants.fieldOfficerIdParamName, apiRequestBodyAsJsonElement);
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.maxDepositTermTypeIdParamName, apiRequestBodyAsJsonElement)) {
            ...
            final JsonElement maxDepositTermType = fromApiJsonHelper.extractJsonObjectNamed(DepositsApiConstants.maxDepositTermType, loanTemplateElement);
            maxDepositTermTypeId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.idParamName,
                    maxDepositTermType);
        }
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.mandatoryRecommendedDepositAmountParamName, apiRequestBodyAsJsonElement)) {
            mandatoryRecommendedDepositAmount = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(DepositsApiConstants.mandatoryRecommendedDepositAmountParamName,
                    apiRequestBodyAsJsonElement);
        } else {
            mandatoryRecommendedDepositAmount = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(DepositsApiConstants.mandatoryRecommendedDepositAmountParamName,
                    loanTemplateElement);
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.depositPeriodFrequencyIdParamName, apiRequestBodyAsJsonElement)) {
            depositPeriodFrequencyId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.depositPeriodFrequencyIdParamName,
                    apiRequestBodyAsJsonElement);
        } else {
            depositPeriodFrequencyId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.depositPeriodFrequencyIdParamName,
                    loanTemplateElement);
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.minDepositTermTypeIdParamName, apiRequestBodyAsJsonElement)) {
            ...
            final JsonElement minDepositTermType = fromApiJsonHelper.extractJsonObjectNamed(DepositsApiConstants.minDepositTermType, loanTemplateElement);
            minDepositTermTypeId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.idParamName,
                    minDepositTermType);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.minOverdraftForInterestCalculationParamName, apiRequestBodyAsJsonElement)) {
            minOverdraftForInterestCalculation = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(SavingsApiConstants.minOverdraftForInterestCalculationParamName,
                    apiRequestBodyAsJsonElement);
        } else {
            minOverdraftForInterestCalculation = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(SavingsApiConstants.minOverdraftForInterestCalculationParamName,
                    loanTemplateElement);
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.minRequiredOpeningBalanceParamName, apiRequestBodyAsJsonElement)) {
            minRequiredOpeningBalance = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(SavingsApiConstants.minRequiredOpeningBalanceParamName,
                    apiRequestBodyAsJsonElement);
        } else {
            minRequiredOpeningBalance = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(SavingsApiConstants.minRequiredOpeningBalanceParamName,
                    loanTemplateElement);
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.maturityInstructionIdParamName, apiRequestBodyAsJsonElement)) {
            ...
            maturityInstructionId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.maturityInstructionIdParamName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCalculationDaysInYearTypeParamName, apiRequestBodyAsJsonElement)) {
            interestCalculationDaysInYearType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.interestCalculationDaysInYearTypeParamName,
                    apiRequestBodyAsJsonElement);
        } else {
            final JsonElement interestCalculationDaysInYearTypeElement
                    = fromApiJsonHelper.extractJsonObjectNamed(SavingsApiConstants.interestCalculationDaysInYearTypeParamName, loanTemplateElement);
            interestCalculationDaysInYearType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, interestCalculationDaysInYearTypeElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCalculationTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            final JsonElement interestCalculationTypeElement = fromApiJsonHelper.extractJsonObjectNamed(SavingsApiConstants.interestCalculationTypeParamName, loanTemplateElement);
            interestCalculationType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, interestCalculationTypeElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestPostingPeriodTypeParamName, apiRequestBodyAsJsonElement)) {
            interestPostingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.interestPostingPeriodTypeParamName,
                    apiRequestBodyAsJsonElement);
        } else {
            final JsonElement interestPostingPeriodTypeElement = fromApiJsonHelper.extractJsonObjectNamed(SavingsApiConstants.interestPostingPeriodTypeParamName, loanTemplateElement);
            interestPostingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, interestPostingPeriodTypeElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCompoundingPeriodTypeParamName, apiRequestBodyAsJsonElement)) {
            interestCompoundingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.interestCompoundingPeriodTypeParamName,
                    apiRequestBodyAsJsonElement);
        } else {
            final JsonElement interestCompoundingPeriodTypeElement = fromApiJsonHelper.extractJsonObjectNamed(SavingsApiConstants.interestCompoundingPeriodTypeParamName, loanTemplateElement);
            interestCompoundingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, interestCompoundingPeriodTypeElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.lockinPeriodFrequencyParamName, apiRequestBodyAsJsonElement)) {
            ...
            lockinPeriodFrequency = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.lockinPeriodFrequencyParamName, loanTemplateElement);
        }
...
//            lockinPeriodFrequencyType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, lockinPeriodFrequencyTypeElement);
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.isCalendarInheritedParamName, apiRequestBodyAsJsonElement)) {
            isCalendarInherited = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.isCalendarInheritedParamName, apiRequestBodyAsJsonElement);
        } else {
            isCalendarInherited = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.isCalendarInheritedParamName, loanTemplateElement);
        }
...
//        }
        ...
        //     transferInterestToSavings = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.transferInterestToSavingsParamName, apiRequestBodyAsJsonElement);
        // } else {
        //     transferInterestToSavings = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.transferInterestToSavingsParamName, loanTemplateElement);
        // }
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.preClosurePenalApplicableParamName, apiRequestBodyAsJsonElement)) {
            preClosurePenalApplicable = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.preClosurePenalApplicableParamName, apiRequestBodyAsJsonElement);
        } else {
            preClosurePenalApplicable = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.preClosurePenalApplicableParamName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.enforceMinRequiredBalanceParamName, apiRequestBodyAsJsonElement)) {
            enforceMinRequiredBalance = fromApiJsonHelper.extractBooleanNamed(SavingsApiConstants.enforceMinRequiredBalanceParamName, apiRequestBodyAsJsonElement);
        } else {
            enforceMinRequiredBalance = fromApiJsonHelper.extractBooleanNamed(SavingsApiConstants.enforceMinRequiredBalanceParamName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.allowOverdraftParamName, apiRequestBodyAsJsonElement)) {
            allowOverdraft = fromApiJsonHelper.extractBooleanNamed(SavingsApiConstants.allowOverdraftParamName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.allowWithdrawalParamName, apiRequestBodyAsJsonElement)) {
            allowWithdrawal = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.allowWithdrawalParamName, apiRequestBodyAsJsonElement);
        } else {
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.isMandatoryDepositParamName, apiRequestBodyAsJsonElement)) {
            isMandatoryDeposit = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.isMandatoryDepositParamName, apiRequestBodyAsJsonElement);
        } else {
            isMandatoryDeposit = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.isMandatoryDepositParamName, loanTemplateElement);
        }
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.adjustAdvanceTowardsFuturePaymentsParamName, apiRequestBodyAsJsonElement)) {
            adjustAdvanceTowardsFuturePayments = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.adjustAdvanceTowardsFuturePaymentsParamName, apiRequestBodyAsJsonElement);
        } else {
            adjustAdvanceTowardsFuturePayments = fromApiJsonHelper.extractBooleanNamed(DepositsApiConstants.adjustAdvanceTowardsFuturePaymentsParamName, loanTemplateElement);
        }
        if (adjustAdvanceTowardsFuturePayments != null) {
            jsonObjectLoan.addProperty(DepositsApiConstants.adjustAdvanceTowardsFuturePaymentsParamName, adjustAdvanceTowardsFuturePayments);
        }
        ...
        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.inMultiplesOfDepositTermTypeIdParamName, apiRequestBodyAsJsonElement)) {
            inMultiplesOfDepositTermTypeId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.inMultiplesOfDepositTermTypeIdParamName, apiRequestBodyAsJsonElement);
        } else {
            final JsonElement inMultiplesOfDepositTermType = fromApiJsonHelper.extractJsonObjectNamed(DepositsApiConstants.inMultiplesOfDepositTermType, loanTemplateElement);
            inMultiplesOfDepositTermTypeId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.idParamName, inMultiplesOfDepositTermType);
        }
...
//            final JsonElement accountChart = fromApiJsonHelper.extractJsonObjectNamed(accountChartParamName, loanTemplateElement);
...
//                final JsonArray fromDateArray = fromApiJsonHelper.extractJsonArrayNamed(InterestRateChartApiConstants.fromDateParamName, accountChart);
...
//            }
//
//            final JsonArray chartSlabs = fromApiJsonHelper.extractJsonArrayNamed(InterestRateChartApiConstants.chartSlabs, accountChart);
...
//
//                final Long fromPeriod = fromApiJsonHelper.extractLongNamed(InterestRateChartSlabApiConstants.fromPeriodParamName, chartSlab);
//                chartSlabObject.addProperty(InterestRateChartSlabApiConstants.fromPeriodParamName, fromPeriod);
//                final BigDecimal annualInterestRate = fromApiJsonHelper.extractBigDecimalWithLocaleNamed(InterestRateChartSlabApiConstants.annualInterestRateParamName, chartSlab);
//                chartSlabObject.addProperty(InterestRateChartSlabApiConstants.annualInterestRateParamName, annualInterestRate);
//
//                final JsonArray incentives = fromApiJsonHelper.extractJsonArrayNamed(InterestRateChartSlabApiConstants.incentivesParamName, chartSlab);
//                chartSlabObject.add(InterestRateChartSlabApiConstants.incentivesParamName, incentives);
//                final JsonElement periodType = fromApiJsonHelper.extractJsonObjectNamed(InterestRateChartSlabApiConstants.periodTypeParamName, chartSlab);
//                final Long periodTypeId = fromApiJsonHelper.extractLongNamed(InterestRateChartSlabApiConstants.idParamName, periodType);
...
//                    locale = fromApiJsonHelper.extractStringNamed(InterestRateChartSlabApiConstants.localeParamName, chartSlab);
//                }
...
//            charts.add(chartObject);
    ...
    public static String fixedTemplateConfig(final FixedDepositAccountsApiResource fixedDepositAccountsApiResource, final String apiRequestBodyAsJson,
            final FromJsonHelper fromApiJsonHelper, final boolean staffInSelectedOfficeOnly,
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCalculationTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            final JsonElement interestCalculationTypeElement
                    = fromApiJsonHelper.extractJsonObjectNamed(SavingsApiConstants.interestCalculationTypeParamName, loanTemplateElement);
            interestCalculationType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, interestCalculationTypeElement);
        }
        if (interestCalculationType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.interestCalculationTypeParamName, interestCalculationType);
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestPostingPeriodTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            final JsonElement interestPostingPeriodTypeElement
                    = fromApiJsonHelper.extractJsonObjectNamed(SavingsApiConstants.interestPostingPeriodTypeParamName, loanTemplateElement);
            interestPostingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, interestPostingPeriodTypeElement);
        }
        if (interestPostingPeriodType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.interestPostingPeriodTypeParamName, interestPostingPeriodType);
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCompoundingPeriodTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            final JsonElement interestCompoundingPeriodTypeElement
                    = fromApiJsonHelper.extractJsonObjectNamed(SavingsApiConstants.interestCompoundingPeriodTypeParamName, loanTemplateElement);
            interestCompoundingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.idParamName, interestCompoundingPeriodTypeElement);
        }
        if (interestCompoundingPeriodType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.interestCompoundingPeriodTypeParamName, interestCompoundingPeriodType);
...
//        } else {
//            final JsonElement inMultiplesOfDepositTermType = fromApiJsonHelper.extractJsonObjectNamed(DepositsApiConstants.inMultiplesOfDepositTermType, loanTemplateElement);
//            inMultiplesOfDepositTermTypeId = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.inMultiplesOfDepositTermTypeIdParamName, inMultiplesOfDepositTermType);
//        }
//        if (inMultiplesOfDepositTermTypeId != null) {
//            jsonObjectLoan.addProperty(DepositsApiConstants.inMultiplesOfDepositTermTypeIdParamName, inMultiplesOfDepositTermTypeId);
//        }
//        Integer inMultiplesOfDepositTerm;
//        if (fromApiJsonHelper.parameterExists(DepositsApiConstants.inMultiplesOfDepositTermParamName, apiRequestBodyAsJsonElement)) {
//            inMultiplesOfDepositTerm = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.inMultiplesOfDepositTermParamName, apiRequestBodyAsJsonElement);
//        } else {
//            inMultiplesOfDepositTerm = fromApiJsonHelper.extractIntegerSansLocaleNamed(DepositsApiConstants.inMultiplesOfDepositTermParamName, loanTemplateElement);
//        }
...
//            charts.add(chartObject);
    ...
    public static String savingsTemplateConfig(final SavingsAccountsApiResource savingsAccountsApiResource, final String apiRequestBodyAsJson,
            final FromJsonHelper fromApiJsonHelper, final boolean staffInSelectedOfficeOnly,
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCalculationDaysInYearTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            interestCalculationDaysInYearType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.interestCalculationDaysInYearTypeParamName, loanTemplateElement);
        }
        if (interestCalculationDaysInYearType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.interestCalculationDaysInYearTypeParamName, interestCalculationDaysInYearType);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCalculationTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            interestCalculationType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.interestCalculationTypeParamName, loanTemplateElement);
        }
        if (interestCalculationType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.interestCalculationTypeParamName, interestCalculationType);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestPostingPeriodTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            interestPostingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.interestPostingPeriodTypeParamName, loanTemplateElement);
        }
        if (interestPostingPeriodType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.interestPostingPeriodTypeParamName, interestPostingPeriodType);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.interestCompoundingPeriodTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            interestCompoundingPeriodType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.interestCompoundingPeriodTypeParamName, loanTemplateElement);
        }
        if (interestCompoundingPeriodType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.interestCompoundingPeriodTypeParamName, interestCompoundingPeriodType);
        }
        ...
        if (fromApiJsonHelper.parameterExists(SavingsApiConstants.lockinPeriodFrequencyTypeParamName, apiRequestBodyAsJsonElement)) {
            ...
            lockinPeriodFrequencyType = fromApiJsonHelper.extractIntegerSansLocaleNamed(SavingsApiConstants.lockinPeriodFrequencyTypeParamName, loanTemplateElement);
        }
        if (lockinPeriodFrequencyType != null) {
            jsonObjectLoan.addProperty(SavingsApiConstants.lockinPeriodFrequencyTypeParamName, lockinPeriodFrequencyType);
        }
