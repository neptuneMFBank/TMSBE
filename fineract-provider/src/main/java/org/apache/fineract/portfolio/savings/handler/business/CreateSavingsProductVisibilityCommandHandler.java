...
public class CreateSavingsProductVisibilityCommandHandler implements NewCommandSourceHandler {
    ...
    @Autowired
    public CreateSavingsProductVisibilityCommandHandler(final ProductVisibilityWriteService loanProductVisibilityWriteService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.loanProductVisibilityWriteService.createProductVisibility(command);
    }
}
