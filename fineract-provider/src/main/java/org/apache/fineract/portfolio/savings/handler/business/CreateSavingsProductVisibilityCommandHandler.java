...
@Service
@CommandType(entity = ProductVisibilityApiResourceConstants.SAVINGS_VISIBILITY_RESOURCENAME, action = "CREATE")
public class CreateSavingsProductVisibilityCommandHandler implements NewCommandSourceHandler {

    private final LoanProductVisibilityWriteService loanProductVisibilityWriteService;

    @Autowired
    public CreateSavingsProductVisibilityCommandHandler(final LoanProductVisibilityWriteService loanProductVisibilityWriteService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        return this.loanProductVisibilityWriteService.createLoanProductVisibility(command);
    }
}
