...
@Service
@CommandType(entity = ProductVisibilityApiResourceConstants.SAVINGS_VISIBILITY_RESOURCENAME, action = "DELETE")
public class DeleteSavingsProductVisibilityCommandHandler implements NewCommandSourceHandler {

    private final LoanProductVisibilityWriteService writePlatformService;

    @Autowired
    public DeleteSavingsProductVisibilityCommandHandler(final LoanProductVisibilityWriteService writePlatformService) {
