...
@Service
@CommandType(entity = "SAVINGSACCOUNT", action = "UNDOTRANSACTIONBULK")
public class UndoBulkTransactionSavingsAccountCommandHandler implements NewCommandSourceHandler {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.undoBulkSavingsTransaction(command.getSavingsId(), transactionId);
    }
}
