...
public interface SavingsProductBusinessReadPlatformService {
    ...
    Collection<SavingsProductData> retrieveRestrictedProductsForMix(Long productId);

    Collection<SavingsProductData> retrieveAllowedProductsForMix(Long productId);
}
