...
@Component
public class SelfFixedDepositDataValidator {

    private final FromJsonHelper fromApiJsonHelper;

    @Autowired
    public SelfFixedDepositDataValidator(final FromJsonHelper fromApiJsonHelper) {
        this.fromApiJsonHelper = fromApiJsonHelper;
    }

    public void validateRetrieveFixedDepositTransaction(final UriInfo uriInfo) {
