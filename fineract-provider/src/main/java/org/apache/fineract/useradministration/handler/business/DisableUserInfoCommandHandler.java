...
@Service
@CommandType(entity = "USER", action = "DISABLE")
public class DisableUserInfoCommandHandler implements NewCommandSourceHandler {

    private final AppUserBusinessWritePlatformService writePlatformService;

    @Autowired
    public DisableUserInfoCommandHandler(final AppUserBusinessWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.disableUser(userId);
    }
}
