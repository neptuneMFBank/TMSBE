...
@Service
@CommandType(entity = "USER", action = "ENABLE")
public class EnableUserInfoCommandHandler implements NewCommandSourceHandler {

    private final AppUserBusinessWritePlatformService writePlatformService;

    @Autowired
    public EnableUserInfoCommandHandler(final AppUserBusinessWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.enableUser(userId);
    }
}
