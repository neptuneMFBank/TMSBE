...
@Service
@CommandType(entity = "USER", action = "LOCK")
public class LockUserInfoCommandHandler implements NewCommandSourceHandler {

    private final AppUserBusinessWritePlatformService writePlatformService;

    @Autowired
    public LockUserInfoCommandHandler(final AppUserBusinessWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.lockUser(userId);
    }
}
