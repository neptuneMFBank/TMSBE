...
public class UnLockUserInfoCommandHandler implements NewCommandSourceHandler {

    private final AppUserBusinessWritePlatformService writePlatformService;

    @Autowired
    public UnLockUserInfoCommandHandler(final AppUserBusinessWritePlatformService writePlatformService) {
    ...
    public CommandProcessingResult processCommand(final JsonCommand command) {
        ...
        return this.writePlatformService.unLockUser(userId);
    }
}
