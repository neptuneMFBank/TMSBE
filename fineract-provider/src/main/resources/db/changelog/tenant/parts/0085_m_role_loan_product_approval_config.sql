...
CREATE TABLE `m_role_loan_product_approval_config`(
      ...
      CONSTRAINT `config_FK_created_by` FOREIGN KEY (`created_by`) REFERENCES m_appuser(`id`),
      CONSTRAINT `config_FK_last_modified_by` FOREIGN KEY (`last_modified_by`) REFERENCES m_appuser(`id`)
