...
VALUES (NULL, 'Queue Self Client Activate', 'Queue Self Client Activate', '0 0/5 * * * ?', curdate(), 5, NULL, NULL, '2017-02-25 00:01:00', 'Queue Self Client ActivateJobDetail1 _ DEFAULT', NULL, 1, 0, 1, 0, 0,1)
